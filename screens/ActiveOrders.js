...
export default function ActiveOrders(props) {
    return(
        <ScrollView>
            ...
            <Text style={{textAlign: 'center', fontSize: 30, fontWeight: 'bold', borderWidth: 2, marginHorizontal: 50, marginBottom: 30}}>Active Orders</Text>
            <ActiveOrder veges={['tomato', 'potato']} quantities={['1kg', '2kg']} prices={[100, 80]} orderNo='4534' placedOn='18th june' deliveredBy='Expected Delivery : 10 am tue'/>
            <ActiveOrder veges={['tomato', 'potato', 'chillie']} quantities={['1kg', '2kg', '500gms']} prices={[100, 80, 40]} orderNo='4534' placedOn='18th june' deliveredBy='Expected Delivery : 10 am tue'/>
            <ActiveOrder veges={['tomato', 'potato']} quantities={['1kg', '2kg']} prices={[100, 80]} orderNo='4534' placedOn='18th june' deliveredBy='Expected Delivery : 10 am tue'/>
            <ActiveOrder veges={['tomato', 'potato']} quantities={['1kg', '2kg']} prices={[100, 80]} orderNo='4534' placedOn='18th june' deliveredBy='Expected Delivery : 10 am tue'/>
            <ActiveOrder veges={['tomato', 'potato']} quantities={['1kg', '2kg']} prices={[100, 80]} orderNo='4534' placedOn='18th june' deliveredBy='Expected Delivery : 10 am tue'/>
            <ActiveOrder veges={['tomato', 'potato']} quantities={['1kg', '2kg']} prices={[100, 80]} orderNo='4534' placedOn='18th june' deliveredBy='Expected Delivery : 10 am tue'/>
